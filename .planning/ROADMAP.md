...
- [x] 15-04-PLAN.md — (gap closure) Fix env var contamination in unit tests; restore per-warehouse dotenv loading in integration tests
- [x] 15-05-PLAN.md — (gap closure) Record real Snowflake cassettes; verify full test suite passes with 0 failures
...
| 15. Replace Syrupy with pytest-adbc-replay | 5/5 | Complete    | 2026-03-07 |
