...
class TestExceptionHierarchy:
    """Exception hierarchy: PoolhouseError, ConfigurationError."""
...
Commit: `test(05-02): add failing tests for create_pool factory (RED)`
  ...
  <done>tests/test_pool_factory.py exists with all test classes; running it produces failures/errors (not passes) because create_pool is not yet implemented.</done>
</task>
...
Commit: `feat(05-02): implement create_pool factory with Arrow cleanup and public exports (GREEN)`
  ...
  <done>All tests in test_pool_factory.py pass; uv run pytest tests/ -x passes (no regressions); prek passes with zero violations.</done>
</task>
