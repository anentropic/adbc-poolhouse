...
The async API is experimental and incomplete. Its surface may change between minor releases, and several features (async metadata and prepared statements) have not shipped yet. See the [async pool guide](guides/async.md) for the full caveat.
